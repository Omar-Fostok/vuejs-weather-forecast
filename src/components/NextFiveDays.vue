<template>
  <div>
    <div class="nextFiveDays">
      <h2>Next 5 days</h2>
      <div class="row" id="nextFiveDays">
        <div class="col-md-2 col-md-offset-1"></div>
        <Day
          v-for="index in 5"
          :key="index"
          :shortDayName="shortDayNames[index - 1]"
          :numberDate="numberDates[index - 1]"
          :lastImage="lastImages[index - 1]"
          :lowTemp="lowTemps[index - 1]"
          :highTemp="highTemps[index - 1]"
